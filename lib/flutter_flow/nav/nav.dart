...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? NavBarPage() : StartPage111Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            FFRoute(
              name: 'StartPage111',
              path: 'StartPage111',
              builder: (context, params) => StartPage111Widget(),
            ),
            FFRoute(
              name: 'SMSpage111',
              path: 'sMSpage111',
              builder: (context, params) => SMSpage111Widget(),
            ),
            FFRoute(
              name: 'MyProfile',
              path: 'myProfile',
            ...
            FFRoute(
              ...
              asyncParams: {
                'ev': getDoc(['events'], EventsRecord.fromSnapshot),
              },
              builder: (context, params) => SingleEventPageWidget(
                ev: params.getParam('ev', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'CategoriesPage',
            ...
            FFRoute(
              ...
              builder: (context, params) => SingleCatPageWidget(
                cat: params.getParam('cat', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Settings',
            ...
            FFRoute(
              ...
              builder: (context, params) => UsersProfileWidget(
            ...
            FFRoute(
              ...
              builder: (context, params) => ConfidentialityWidget(),
            ),
            FFRoute(
              name: 'Notifications',
              path: 'notifications',
            ...
            FFRoute(
              name: 'Safety',
              path: 'safety',
              builder: (context, params) => SafetyWidget(),
            ),
            FFRoute(
              name: 'Support',
              path: 'support',
            ...
            FFRoute(
              name: 'Support_1',
              path: 'support1',
              builder: (context, params) => Support1Widget(),
            ),
            FFRoute(
              name: 'Payment',
              path: 'payment',
            ...
            FFRoute(
              ...
              builder: (context, params) => RegistrationEventWidget(
                ev: params.getParam('ev', ParamType.Document),
              ),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'onlain',
              path: 'onlain',
              builder: (context, params) => OnlainWidget(),
            ),
            FFRoute(
              name: 'offline',
              path: 'offline',
            ...
            FFRoute(
              name: 'interese',
              path: 'interese',
              builder: (context, params) => IntereseWidget(
                photo: params.getParam('photo', ParamType.String),
                teg: params.getParam('teg', ParamType.String),
                name: params.getParam('name', ParamType.String),
                photo2: params.getParam('photo2', ParamType.String),
            ...
            FFRoute(
              ...
              path: 'changeEvent',
              asyncParams: {
                'change': getDoc(['events'], EventsRecord.fromSnapshot),
              },
