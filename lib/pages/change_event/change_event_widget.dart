...
import 'change_event_model.dart';
export 'change_event_model.dart';

class ChangeEventWidget extends StatefulWidget {
  const ChangeEventWidget({
    Key? key,
    required this.change,
  }) : super(key: key);

  final EventsRecord? change;

  @override
  _ChangeEventWidgetState createState() => _ChangeEventWidgetState();
}

class _ChangeEventWidgetState extends State<ChangeEventWidget> {
  late ChangeEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangeEventModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.category = widget.change!.categories.toList();
        _model.image = widget.change!.fotoPath;
        _model.time = widget.change!.date;
      });
    });

    _model.textController1 ??= TextEditingController(text: widget.change!.name);
    _model.limitPlacesController ??=
        TextEditingController(text: widget.change!.limit.toString());
    _model.fulTextController ??=
        TextEditingController(text: widget.change!.description);
    _model.textController4 ??=
        TextEditingController(text: widget.change!.price.toString());
    _model.textController5 ??=
        TextEditingController(text: widget.change!.discounts.toString());
  }
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown<bool>(
                                controller:
                                    _model.onlainofflineValueController ??=
                                        FormFieldController<bool>(
                                  _model.onlainofflineValue ??=
                                      widget.change!.isOnline,
                                ),
                                options: [true, false],
                                optionLabels: ['Онлайн', 'Оффлайн'],
                                onChanged: (val) => setState(
                                    () => _model.onlainofflineValue = val),
                                width: double.infinity,
                                height: 50.0,
                                searchHintTextStyle:
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Switch(
                                      value: _model.limitedValue ??=
                                          widget.change!.isAgeRestricted,
                              ...
                              if (_model.limitedValue ?? true)
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.ogranechenieValueController ??=
                                          FormFieldController<String>(
                                    _model.ogranechenieValue ??=
                                        widget.change!.restriction,
                                  ),
                                  options: ['7+', '12+', '16+', '18+', '21+'],
                                  onChanged: (val) => setState(
                                      () => _model.ogranechenieValue = val),
                                  width: double.infinity,
                                  height: 50.0,
                                  searchHintTextStyle:
                                      FlutterFlowTheme.of(context)
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Switch(
                                      value: _model.limitedPlacesValue ??=
                                          widget.change!.hasLimit,
                                      onChanged: (newValue) async {
                                        setState(() => _model
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: FFButtonWidget(
                                      ...
                                      text:
                                          '${dateTimeFormat('yMMMd', _model.time)}, ${dateTimeFormat('Hm', _model.time)}',
                              ...
                              Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Switch(
                                        value: _model.paidValue ??=
                                            widget.change!.isPaid,
                                        onChanged: (newValue) async {
                                          setState(() =>
                                  ...
                                  if (_model.checkboxValue!) {
                                    final eventsUpdateData = {
                                      ...createEventsRecordData(
                                        ...
                                        host: widget.change!.host,
                                        fotoPath: _model.image,
                                        description:
                                            _model.fulTextController.text,
                                        isPaid: _model.paidValue,
                                        isOnline: _model.onlainofflineValue,
                                        date: _model.time,
                                        ...
                                        limit: _model.limitedPlacesValue!
                                            ...
                                            : null,
                                        restriction: _model.limitedValue!
                                            ? _model.ogranechenieValue
                                            : null,
                                      ),
                                      'categories': _model.category,
                                    };
                                    await widget.change!.reference
